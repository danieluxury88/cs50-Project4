    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('SU', 'Superuser'), ('US', 'User'), ('GE', 'Guest')], default='US', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='writer', to='network.post')),
            ],
            options={
